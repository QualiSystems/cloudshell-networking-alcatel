...
class TestSnmp(BaseAlcatelTestCase):
    def _setUp(self, attrs=None):
        ...
        self.runner = AlcatelAutoloadRunner(
            self.resource_config, self.logger, self.snmp_handler
        )

    @patch(
        "cloudshell.networking.alcatel.flows.alcatel_autoload_flow."
        "AlcatelGenericSNMPAutoload"
    )
    ...
    def test_enable_snmp_v2(
        self, send_mock, recv_mock, cb_mock, paramiko_mock, quali_snmp, autoload
    ):
        self._setUp()
    ...
    @patch("cloudshell.cli.session.ssh_session.SSHSession._receive_all")
    @patch("cloudshell.cli.session.ssh_session.SSHSession.send_line")
    def test_already_enabled_snmp_v2(
        self, send_mock, recv_mock, cb_mock, paramiko_mock, quali_snmp, autoload
    ):
        self._setUp()
    ...
    @patch("cloudshell.cli.session.ssh_session.SSHSession._receive_all")
    @patch("cloudshell.cli.session.ssh_session.SSHSession.send_line")
    def test_disable_snmp_v2(
        self, send_mock, recv_mock, cb_mock, paramiko_mock, quali_snmp, autoload
    ):
        self._setUp({"Enable SNMP": "False", "Disable SNMP": "True"})
    ...
    def test_autoload(self, snmp_mock):
        self._setUp({"Enable SNMP": "False"})
        property_map = {
            (
                "SNMPv2-MIB",
                "sysDescr",
                "0",
            ): """TiMOS-B-8.0.R4 both/mpc ALCATEL SAS-M 7210 Copyright (c) 2000-2016 Alcatel-Lucent.
All rights reserved. All use subject to applicable license agreements.
Built on Thu Mar 3 13:32:09 IST 2016 by builder in /home/builder/8.0B1/R4/panos/main""",
            ...
            (
                ...
                "sysObjectID",
                "0",
            ): "TIMETRA-GLOBAL-MIB::tmnxBasedProducts.2.1.2.2.1",
            ...
            (
                ...
                "tmnxPortDescription",
                "1.37781504",
            ): "To aar01awsccc-Te0/0/2/1-CableID",
        ...
        table_map = {
            ...
            ("IP-MIB", "ipAddrTable"): QualiMibTable(
                "ipAddrTable",
                **{
                    "172.168.1.2": {
                        "ipAdEntAddr": "172.168.1.2",
                        "ipAdEntIfIndex": "2",
                        "suffix": "172.168.1.2",
            ...
            ("TIMETRA-CHASSIS-MIB", "tmnxHwName"): QualiMibTable(
                "tmnxHwName",
                **{
                    ...
                    "1.83886082": {
                        "tmnxHwName": "Power Supply 2",
                        "suffix": "1.83886082",
                    },
                    "1.167772162": {"tmnxHwName": "Slot A", "suffix": "1.167772162"},
                    "1.83886081": {
                        "tmnxHwName": "Power Supply 1",
                        "suffix": "1.83886081",
                    },
                }
            ),
            ("TIMETRA-PORT-MIB", "tmnxPortName"): QualiMibTable(
                "tmnxPortName",
                **{
        ...
        snmp_mock().get_properties.side_effect = lambda mib, i, _: properties_map[
            (mib, i)
        ]
