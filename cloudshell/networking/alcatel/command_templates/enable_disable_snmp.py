...
# SNMP V2
ENABLE_SNMPV2 = CommandTemplate(
    "configure system security snmp community "
    "{snmp_community} {access_mode} version v2c"
)
DISABLE_SNMPV2 = CommandTemplate(
    "configure system security snmp no community {snmp_community}"
)
...
ENABLE_VIEW = CommandTemplate(
    "configure system security snmp view {view} subtree 1 mask ff"
)
...
DISABLE_GROUP = CommandTemplate(
    "configure system security snmp no access group {group}"
)

ENABLE_USER_ACCESS = CommandTemplate(
    "configure system security user {user} access snmp"
)
