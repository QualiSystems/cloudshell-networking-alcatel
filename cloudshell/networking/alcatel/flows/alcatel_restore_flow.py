...
class AlcatelRestoreFlow(RestoreConfigurationFlow):
    ...
    def execute_flow(
        ...
        :param str restore_method: the restore method to use when restoring the
            configuration file, append and override
        :param str configuration_type: the configuration type to restore,
            startup or running
